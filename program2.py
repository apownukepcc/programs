...
def CalculateRMSE():
    ...
    (May through August) and for Lake-1, trains a K-Nearest Neighbors regressor on the data, 
    ...
    model = KNeighborsRegressor()  # You can adjust parameters like n_neighbors if desired
